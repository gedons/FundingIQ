...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-4 mb-4">
            <div class="card d-flex flex-row justify-content-between align-items-center p-3">
                <div class="price"><b>Total Users</b>: 76</div>
                <div>
        ...
        <div class="col-12 col-md-6 col-lg-4 mb-4">
            <div class="card d-flex flex-row justify-content-between align-items-center p-3">
                <div class="price"><b>Total Balance</b>: ${{ number_format(Auth::user()->balance, 2) }}</div>
                <div>
    ...
    <div class="row mt-4">
        <div class="col-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">User Funding Transactions</h5>
