                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current"><a href="{{route('front.contact')}}">Contact</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
        ...
        <section class="page-title centred">
            ...
            <div class="auto-container">
              <div class="content-box d-flex flex-column">
                ...
                <p class="text-center">Fill in the contact form below</p>
        ...
        <div class="auto-container">
            ...
            <form method="post" action="https://azim.hostlin.com/Bullion/sendemail.php" id="contact-form">
                ...
                <div class="message-btn">
                    <button type="submit" class="theme-btn btn-one" name="submit-form"><span>Send Now</span></button>
                </div>
            </form>
        </div>
        </section>
