                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current"><a href="{{route('front.about')}}">About Us</a></li>
        ...
        <section class="page-title centred">
            ...
            <div class="auto-container">
              <div class="content-box d-flex flex-column">
                ...
                <p class="text-center">Exprience a smooth journey</p>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            <div class="sec-title">
                                ...
                                <h2>Shaping Financial Futures Since <span>2010</span></h2>
                            </div>
                            <p>Be part of a forward-thinking community that is shaping the future of finance and cryptocurrency. Whether you’re here to manage your investments, trade cryptocurrencies, or explore new financial opportunities, FIQsingnals is your trusted partner in achieving financial success.</p>
                            <div class="inner-box">
                                <h4>Since</h4>
                                <h2>2010</h2>
                            </div>
                            <p>Founded with a vision to revolutionize financial transactions and cryptocurrency trading, FIQsignals  has grown from a pioneering startup into a leading platform known for its reliability, security, and user-centric approach. Our journey has been marked by a commitment to excellence and a passion for enhancing the financial experience of our users.</p>
                            {{-- <div class="btn-box">
